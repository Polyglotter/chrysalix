 ...
 * 
 */
public class PolyglotterException extends BaseException {
     ...
     */
    public PolyglotterException( final I18n message,
    ...
    public PolyglotterException( final String message,
                                 final Object... arguments ) {
        super( PolyglotterI18n.class, message, arguments );
    }
    ...
    public PolyglotterException( final Throwable cause,
                                 ...
                                 final Object... arguments ) {
        super( PolyglotterI18n.class, cause, message, arguments );
    }
}
