...
public final class ArcTangent extends AbstractOperation< Double > {
    ...
    public static final ValueDescriptor< Double > DESCRIPTOR =
        TransformationFactory.createReadOnlyBoundedOneValueDescriptor( TransformationFactory.createId( ArcTangent.class.getSimpleName() ),
    ...
    private static final List< ValueDescriptor< Number >> INPUT_DESCRIPTORS =
        ...
        Collections.singletonList(
                   TransformationFactory.createWritableBoundedOneValueDescriptor( TransformationFactory.createId( ArcTangent.class.getSimpleName() ),
                                                                                  PolyglotterI18n.arcTangentOperationDescription.text(),
                                                                                  PolyglotterI18n.arcTangentOperationName.text(),
                                                                                  Number.class ) );
