 ...
 */
public final class ArcTangent extends BaseOperation< Double > {
    ...
    public static final Descriptor DESCRIPTOR = new Descriptor() {
        ...
        public String description() {
            return PolyglotterI18n.arcTangentOperationDescription.text();
        }
        ...
        @Override
        public String name() {
            return PolyglotterI18n.arcTangentOperationName.text();
        }
    ...
    /**
     * @param id
     *        the arc tangent operation's unique identifier (cannot be <code>null</code>)
     * @param transformId
     *        the owning transform identifier (cannot be <code>null</code>)
     * @throws IllegalArgumentException
     *         if any inputs are <code>null</code>
     */
    ArcTangent( final QName id,
    ...
    protected void validate() {
        ...
        if ( terms().size() != 1 ) {
            final ValidationProblem problem =
                GrammarFactory.createError( id(), PolyglotterI18n.arcTangentOperationMustHaveOneTerm.text( id() ) );
            ...
            if ( !( value instanceof Number ) ) {
                final ValidationProblem problem =
                    GrammarFactory.createError( id(),
                                                PolyglotterI18n.arcTangentOperationInvalidTermType.text( id(),
                                                                                                         terms().get( 0 ).id() ) );
                problems().add( problem );
            }
        }
