 ...
 */
public final class Min extends AbstractOperation< Number > {

    /**
     * The input term descriptor.
     */
    public static final ValueDescriptor< Number > TERM_DESCRIPTOR =
        TransformationFactory.createValueDescriptor( TransformationFactory.createId( Min.class, "input" ),
                                                     PolyglotterI18n.minOperationInputDescription.text(),
                                                     PolyglotterI18n.minOperationInputName.text(),
                                                     Number.class,
                                                     true,
                                                     1,
                                                     true );
    ...
    public static final OperationDescriptor< Number > DESCRIPTOR =
        new AbstractOperationDescriptor< Number >( TransformationFactory.createId( Min.class ),
                                                   PolyglotterI18n.minOperationDescription.text(),
                                                   PolyglotterI18n.minOperationName.text(),
                                                   Number.class,
                                                   INPUT_DESCRIPTORS ) {
     ...
     */
    Min( final Transformation transformation ) {
        ...
        if ( inputs().isEmpty() ) {
            final ValidationProblem problem =
                TransformationFactory.createError( transformationId(),
                                                   PolyglotterI18n.minOperationHasNoTerms.text( transformationId() ) );
