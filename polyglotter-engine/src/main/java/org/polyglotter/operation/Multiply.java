 ...
 */
public class Multiply extends BaseOperation< Number > {

    /**
     * @param id
     *        the multiply operation's unique identifier (cannot be <code>null</code>)
     * @param transformId
     *        the owning transform identifier (cannot be <code>null</code>)
     * @throws IllegalArgumentException
     *         if any inputs are <code>null</code>
     */
    public Multiply( final QName id,
    ...
    public String description() {
        return PolyglotterI18n.multiplyOperationDescription.text();
    }
    ...
    @Override
    public String name() {
        return PolyglotterI18n.multiplyOperationName.text();
    }
    ...
    protected void validate() {
        ...
        if ( terms().isEmpty() ) {
            final ValidationProblem problem =
                GrammarFactory.createError( id(), PolyglotterI18n.multiplyOperationHasNoTerms.text( id() ) );
