...
public final class HyperbolicTangent extends AbstractOperation< Double > {
    ...
    public static final ValueDescriptor< Double > DESCRIPTOR =
        TransformationFactory.createReadOnlyBoundedOneValueDescriptor( TransformationFactory.createId( HyperbolicTangent.class.getSimpleName() ),
    ...
    private static final List< ValueDescriptor< Number >> INPUT_DESCRIPTORS =
        ...
        Collections.singletonList(
                   TransformationFactory.createWritableBoundedOneValueDescriptor( TransformationFactory.createId( HyperbolicTangent.class.getSimpleName() ),
                                                                                  PolyglotterI18n.hyperbolicTangentOperationDescription.text(),
                                                                                  PolyglotterI18n.hyperbolicTangentOperationName.text(),
                                                                                  Number.class ) );
