...
public final class HyperbolicTangent extends AbstractOperation< Double > {
    ...
    public static final Descriptor DESCRIPTOR = new Descriptor() {
        ...
        public String description() {
            return PolyglotterI18n.hyperbolicTangentOperationDescription.text();
        }
        ...
        @Override
        public String name() {
            return PolyglotterI18n.hyperbolicTangentOperationName.text();
        }
    ...
    /**
     * @param id
     *        the hyperbolic tangent operation's unique identifier (cannot be <code>null</code>)
     * @param transformId
     *        the owning transform identifier (cannot be <code>null</code>)
     * @throws IllegalArgumentException
     *         if any inputs are <code>null</code>
     */
    HyperbolicTangent( final QName id,
    ...
    public void validate() {
        ...
        if ( terms().size() != 1 ) {
            final ValidationProblem problem =
                GrammarFactory.createError( id(), PolyglotterI18n.hyperbolicTangentOperationMustHaveOneTerm.text( id() ) );
                ...
                if ( !( value instanceof Number ) ) {
                    final ValidationProblem problem =
                        GrammarFactory.createError( id(),
                                                    PolyglotterI18n.hyperbolicTangentOperationInvalidTermType.text( id(),
                                                                                                                    term.id() ) );
                    problems().add( problem );
                }
