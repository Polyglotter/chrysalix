...
public final class Sine extends AbstractOperation< Double > {
    ...
    public static final ValueDescriptor< Double > DESCRIPTOR =
        TransformationFactory.createReadOnlyBoundedOneValueDescriptor( TransformationFactory.createId( Sine.class.getSimpleName() ),
    ...
    private static final List< ValueDescriptor< Number >> INPUT_DESCRIPTORS =
        ...
        Collections.singletonList(
                   TransformationFactory.createWritableBoundedOneValueDescriptor( TransformationFactory.createId( Sine.class.getSimpleName() ),
                                                                                  PolyglotterI18n.sineOperationDescription.text(),
                                                                                  PolyglotterI18n.sineOperationName.text(),
                                                                                  Number.class ) );
