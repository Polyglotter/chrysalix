...
public final class HyperbolicSine extends AbstractOperation< Double > {
    ...
    public static final Descriptor DESCRIPTOR = new Descriptor() {
        ...
        public String description() {
            return PolyglotterI18n.hyperbolicSineOperationDescription.text();
        }
        ...
        @Override
        public String name() {
            return PolyglotterI18n.hyperbolicSineOperationName.text();
        }
    ...
    /**
     * @param id
     *        the hyperbolic sine operation's unique identifier (cannot be <code>null</code>)
     * @param transformId
     *        the owning transform identifier (cannot be <code>null</code>)
     * @throws IllegalArgumentException
     *         if any inputs are <code>null</code>
     */
    HyperbolicSine( final QName id,
    ...
    public void validate() {
        ...
        if ( terms().size() != 1 ) {
            final ValidationProblem problem =
                GrammarFactory.createError( id(), PolyglotterI18n.hyperbolicSineOperationMustHaveOneTerm.text( id() ) );
                ...
                if ( !( value instanceof Number ) ) {
                    final ValidationProblem problem =
                        GrammarFactory.createError( id(),
                                                    PolyglotterI18n.hyperbolicSineOperationInvalidTermType.text( id(),
                                                                                                                 term.id() ) );
                    problems().add( problem );
                }
