...
public final class HyperbolicSine extends AbstractOperation< Double > {
    ...
    public static final ValueDescriptor< Double > DESCRIPTOR =
        TransformationFactory.createReadOnlyBoundedOneValueDescriptor( TransformationFactory.createId( HyperbolicSine.class.getSimpleName() ),
    ...
    private static final List< ValueDescriptor< Number >> INPUT_DESCRIPTORS =
        ...
        Collections.singletonList(
                   TransformationFactory.createWritableBoundedOneValueDescriptor( TransformationFactory.createId( HyperbolicSine.class.getSimpleName() ),
                                                                                  PolyglotterI18n.hyperbolicSineOperationDescription.text(),
                                                                                  PolyglotterI18n.hyperbolicSineOperationName.text(),
                                                                                  Number.class ) );
