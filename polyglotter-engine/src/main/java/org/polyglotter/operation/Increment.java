 ...
 * Increments the term.
 */
public class Increment extends BaseOperation< Integer > {
     ...
     */
    public Increment( final QName id,
            ...
            if ( !( value instanceof Integer ) ) {
                final ValidationProblem problem =
                    GrammarFactory.createError( id(),
                                                PolyglotterI18n.incrementOperationInvalidTermType.text( terms().get( 0 ).id(),
                                                                                                        id() ) );
                problems().add( problem );
            }
        }
