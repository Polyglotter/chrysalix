 ...
 */
public final class Divide extends BaseOperation< Number > {
    ...
    public static final Descriptor DESCRIPTOR = new Descriptor() {
        ...
        public String description() {
            return PolyglotterI18n.divideOperationDescription.text();
        }
        ...
        @Override
        public String name() {
            return PolyglotterI18n.divideOperationName.text();
        }
    ...
    protected void validate() {
        ...
        if ( terms().isEmpty() ) {
            final ValidationProblem problem =
                GrammarFactory.createError( id(), PolyglotterI18n.divideOperationHasNoTerms.text( id() ) );
