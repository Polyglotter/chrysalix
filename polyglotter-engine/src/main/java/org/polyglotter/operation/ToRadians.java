...
public final class ToRadians extends AbstractOperation< Double > {
    ...
    public static final Descriptor DESCRIPTOR = new Descriptor() {
        ...
        public String description() {
            return PolyglotterI18n.toRadiansOperationDescription.text();
        }
        ...
        @Override
        public String name() {
            return PolyglotterI18n.toRadiansOperationName.text();
        }
    ...
    public void validate() {
        ...
        if ( terms().size() != 1 ) {
            final ValidationProblem problem =
                GrammarFactory.createError( id(), PolyglotterI18n.toRadiansOperationMustHaveOneTerm.text( id() ) );
                ...
                if ( !( value instanceof Number ) ) {
                    final ValidationProblem problem =
                        GrammarFactory.createError( id(),
                                                    PolyglotterI18n.toRadiansOperationInvalidTermType.text( id(),
                                                                                                            term.id() ) );
                    problems().add( problem );
                }
