 ...
 */
public final class ToRadians extends AbstractOperation< Double > {

    /**
     * The output descriptor.
     */
    public static final ValueDescriptor< Double > DESCRIPTOR =
        TransformationFactory.createReadOnlyBoundedOneValueDescriptor( TransformationFactory.createId( ToRadians.class.getSimpleName() ),
    ...
    private static final List< ValueDescriptor< Number >> INPUT_DESCRIPTORS =
        ...
        Collections.singletonList(
                   TransformationFactory.createWritableBoundedOneValueDescriptor( TransformationFactory.createId( ToRadians.class.getSimpleName() ),
                                                                                  PolyglotterI18n.toRadiansOperationDescription.text(),
                                                                                  PolyglotterI18n.toRadiansOperationName.text(),
                                                                                  Number.class ) );
     ...
     */
    ToRadians( final Transformation transformation ) {
