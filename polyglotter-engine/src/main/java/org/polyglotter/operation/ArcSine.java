...
public final class ArcSine extends AbstractOperation< Double > {
    ...
    public static final ValueDescriptor< Double > DESCRIPTOR =
        TransformationFactory.createReadOnlyBoundedOneValueDescriptor( TransformationFactory.createId( ArcSine.class.getSimpleName() ),
    ...
    private static final List< ValueDescriptor< Number >> INPUT_DESCRIPTORS =
        ...
        Collections.singletonList(
                   TransformationFactory.createWritableBoundedOneValueDescriptor( TransformationFactory.createId( ArcSine.class.getSimpleName() ),
                                                                                  PolyglotterI18n.arcSineOperationDescription.text(),
                                                                                  PolyglotterI18n.arcSineOperationName.text(),
                                                                                  Number.class ) );
