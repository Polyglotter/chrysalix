...
public final class PowerOfEMinus1 extends AbstractOperation< Double > {
    ...
    public static final ValueDescriptor< Double > DESCRIPTOR =
        TransformationFactory.createReadOnlyBoundedOneValueDescriptor( TransformationFactory.createId( PowerOfEMinus1.class.getSimpleName() ),
    ...
    private static final List< ValueDescriptor< Number >> INPUT_DESCRIPTORS =
        ...
        Collections.singletonList(
                   TransformationFactory.createWritableBoundedOneValueDescriptor( TransformationFactory.createId( PowerOfEMinus1.class.getSimpleName() ),
                                                                                  PolyglotterI18n.powerOfEMinus1OperationDescription.text(),
                                                                                  PolyglotterI18n.powerOfEMinus1OperationName.text(),
                                                                                  Number.class ) );
     ...
     */
    PowerOfEMinus1( final Transformation transformation ) {
