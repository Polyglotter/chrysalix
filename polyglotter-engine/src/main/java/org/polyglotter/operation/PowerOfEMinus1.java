...
public final class PowerOfEMinus1 extends AbstractOperation< Double > {
    ...
    public static final Descriptor DESCRIPTOR = new Descriptor() {
        ...
        public String description() {
            return PolyglotterI18n.powerOfEMinus1OperationDescription.text();
        }
        ...
        @Override
        public String name() {
            return PolyglotterI18n.powerOfEMinus1OperationName.text();
        }
    ...
    public void validate() {
        ...
        if ( terms().size() != 1 ) {
            final ValidationProblem problem =
                GrammarFactory.createError( id(), PolyglotterI18n.powerOfEMinus1OperationMustHaveOneTerm.text( id() ) );
                ...
                if ( !( value instanceof Number ) ) {
                    final ValidationProblem problem =
                        GrammarFactory.createError( id(),
                                                    PolyglotterI18n.powerOfEMinus1OperationInvalidTermType.text( id(),
                                                                                                                 term.id() ) );
                    problems().add( problem );
                }
