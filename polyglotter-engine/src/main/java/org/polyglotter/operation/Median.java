...
public final class Median extends AbstractOperation< Number > {
    ...
    public static final ValueDescriptor< Number > DESCRIPTOR =
        TransformationFactory.createReadOnlyBoundedOneValueDescriptor( TransformationFactory.createId( Median.class.getSimpleName() ),
    ...
    private static final List< ValueDescriptor< Number >> INPUT_DESCRIPTORS =
        ...
        Collections.singletonList(
                   TransformationFactory.createValueDescriptor( TransformationFactory.createId( Median.class.getSimpleName() ),
                                                                PolyglotterI18n.medianOperationDescription.text(),
                                                                PolyglotterI18n.medianOperationName.text(),
                                                                Number.class,
                                                                true,
    ...
    protected Number calculate() throws PolyglotterException {
        ...
        { // convert terms to number terms
            ...
            // sort values
            Collections.sort( numberTerms, NumberValue.ASCENDING_SORTER );
        }
