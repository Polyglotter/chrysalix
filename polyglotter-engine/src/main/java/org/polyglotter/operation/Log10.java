...
public final class Log10 extends AbstractOperation< Double > {
    ...
    public static final ValueDescriptor< Double > DESCRIPTOR =
        TransformationFactory.createReadOnlyBoundedOneValueDescriptor( TransformationFactory.createId( Log10.class.getSimpleName() ),
    ...
    private static final List< ValueDescriptor< Number >> INPUT_DESCRIPTORS =
        ...
        Collections.singletonList(
                   TransformationFactory.createWritableBoundedOneValueDescriptor( TransformationFactory.createId( Log10.class.getSimpleName() ),
                                                                                  PolyglotterI18n.log10OperationDescription.text(),
                                                                                  PolyglotterI18n.log10OperationName.text(),
                                                                                  Number.class ) );
