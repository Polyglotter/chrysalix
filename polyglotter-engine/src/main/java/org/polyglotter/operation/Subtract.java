...
public final class Subtract extends AbstractOperation< Number > {
    ...
    public static final ValueDescriptor< Number > DESCRIPTOR =
        TransformationFactory.createReadOnlyBoundedOneValueDescriptor( TransformationFactory.createId( Subtract.class.getSimpleName() ),
    ...
    private static final List< ValueDescriptor< Number >> INPUT_DESCRIPTORS =
        ...
        Collections.singletonList(
                   TransformationFactory.createValueDescriptor( TransformationFactory.createId( Subtract.class.getSimpleName() ),
                                                                PolyglotterI18n.subtractOperationDescription.text(),
                                                                PolyglotterI18n.subtractOperationName.text(),
                                                                Number.class,
                                                                true,
