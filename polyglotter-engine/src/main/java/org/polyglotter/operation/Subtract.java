 ...
 */
public class Subtract extends BaseOperation< Number > {

    /**
     * @param id
     *        the subtract operation unique identifier (cannot be <code>null</code>)
     * @param transformId
     *        the owning transform identifier (cannot be <code>null</code>)
     * @throws IllegalArgumentException
     *         if any inputs are <code>null</code>
     */
    public Subtract( final QName id,
    ...
    public String description() {
        return PolyglotterI18n.subtractOperationDescription.text();
    }
    ...
    @Override
    public String name() {
        return PolyglotterI18n.subtractOperationName.text();
    }
    ...
    protected void validate() {
        ...
        if ( terms().isEmpty() ) {
            final ValidationProblem problem =
                GrammarFactory.createError( id(), PolyglotterI18n.subtractOperationHasNoTerms.text( id() ) );
