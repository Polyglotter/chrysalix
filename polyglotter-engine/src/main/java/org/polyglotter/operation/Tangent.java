...
public final class Tangent extends AbstractOperation< Double > {
    ...
    public static final ValueDescriptor< Double > DESCRIPTOR =
        TransformationFactory.createReadOnlyBoundedOneValueDescriptor( TransformationFactory.createId( Tangent.class.getSimpleName() ),
    ...
    private static final List< ValueDescriptor< Number >> INPUT_DESCRIPTORS =
        ...
        Collections.singletonList(
                   TransformationFactory.createWritableBoundedOneValueDescriptor( TransformationFactory.createId( Tangent.class.getSimpleName() ),
                                                                                  PolyglotterI18n.tangentOperationDescription.text(),
                                                                                  PolyglotterI18n.tangentOperationName.text(),
                                                                                  Number.class ) );
     ...
     */
    Tangent( final Transformation transformation ) {
