...
public final class CubeRoot extends AbstractOperation< Double > {
    ...
    public static final ValueDescriptor< Double > DESCRIPTOR =
        TransformationFactory.createReadOnlyBoundedOneValueDescriptor( TransformationFactory.createId( CubeRoot.class.getSimpleName() ),
    ...
    private static final List< ValueDescriptor< Number >> INPUT_DESCRIPTORS =
        ...
        Collections.singletonList(
                   TransformationFactory.createWritableBoundedOneValueDescriptor( TransformationFactory.createId( CubeRoot.class.getSimpleName() ),
                                                                                  PolyglotterI18n.cubeRootOperationDescription.text(),
                                                                                  PolyglotterI18n.cubeRootOperationName.text(),
                                                                                  Number.class ) );
