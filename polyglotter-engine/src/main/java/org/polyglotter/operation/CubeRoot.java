...
public final class CubeRoot extends AbstractOperation< Double > {
    ...
    public static final Descriptor DESCRIPTOR = new Descriptor() {
        ...
        public String description() {
            return PolyglotterI18n.cubeRootOperationDescription.text();
        }
        ...
        @Override
        public String name() {
            return PolyglotterI18n.cubeRootOperationName.text();
        }
    ...
    public void validate() {
        ...
        if ( terms().size() != 1 ) {
            final ValidationProblem problem =
                GrammarFactory.createError( id(), PolyglotterI18n.cubeRootOperationMustHaveOneTerm.text( id() ) );
                ...
                if ( !( value instanceof Number ) ) {
                    final ValidationProblem problem =
                        GrammarFactory.createError( id(),
                                                    PolyglotterI18n.cubeRootOperationInvalidTermType.text( id(),
                                                                                                           term.id() ) );
                    problems().add( problem );
                }
