...
public final class ArcCosine extends AbstractOperation< Double > {
    ...
    public static final ValueDescriptor< Double > DESCRIPTOR =
        TransformationFactory.createReadOnlyBoundedOneValueDescriptor( TransformationFactory.createId( ArcCosine.class.getSimpleName() ),
    ...
    private static final List< ValueDescriptor< Number >> INPUT_DESCRIPTORS =
        ...
        Collections.singletonList(
                   TransformationFactory.createWritableBoundedOneValueDescriptor( TransformationFactory.createId( ArcCosine.class.getSimpleName() ),
                                                                                  PolyglotterI18n.arcCosineOperationDescription.text(),
                                                                                  PolyglotterI18n.arcCosineOperationName.text(),
                                                                                  Number.class ) );
