...
public final class ArcCosine extends AbstractOperation< Double > {
    ...
    public static final Descriptor DESCRIPTOR = new Descriptor() {
        ...
        public String description() {
            return PolyglotterI18n.arcCosineOperationDescription.text();
        }
        ...
        @Override
        public String name() {
            return PolyglotterI18n.arcCosineOperationName.text();
        }
    ...
    public void validate() {
        ...
        if ( terms().size() != 1 ) {
            final ValidationProblem problem =
                GrammarFactory.createError( id(), PolyglotterI18n.arcCosineOperationMustHaveOneTerm.text( id() ) );
                ...
                if ( !( value instanceof Number ) ) {
                    final ValidationProblem problem =
                        GrammarFactory.createError( id(),
                                                    PolyglotterI18n.arcCosineOperationInvalidTermType.text( id(),
                                                                                                            term.id() ) );
                    problems().add( problem );
                }
