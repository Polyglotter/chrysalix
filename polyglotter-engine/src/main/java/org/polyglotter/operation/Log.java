...
public final class Log extends AbstractOperation< Double > {
    ...
    public static final ValueDescriptor< Double > DESCRIPTOR =
        TransformationFactory.createReadOnlyBoundedOneValueDescriptor( TransformationFactory.createId( Log.class.getSimpleName() ),
    ...
    private static final List< ValueDescriptor< Number >> INPUT_DESCRIPTORS =
        ...
        Collections.singletonList(
                   TransformationFactory.createWritableBoundedOneValueDescriptor( TransformationFactory.createId( Log.class.getSimpleName() ),
                                                                                  PolyglotterI18n.logOperationDescription.text(),
                                                                                  PolyglotterI18n.logOperationName.text(),
                                                                                  Number.class ) );
