...
public final class SquareRoot extends AbstractOperation< Double > {
    ...
    public static final ValueDescriptor< Double > DESCRIPTOR =
        TransformationFactory.createReadOnlyBoundedOneValueDescriptor( TransformationFactory.createId( SquareRoot.class.getSimpleName() ),
    ...
    private static final List< ValueDescriptor< Number >> INPUT_DESCRIPTORS =
        ...
        Collections.singletonList(
                   TransformationFactory.createWritableBoundedOneValueDescriptor( TransformationFactory.createId( SquareRoot.class.getSimpleName() ),
                                                                                  PolyglotterI18n.squareRootOperationDescription.text(),
                                                                                  PolyglotterI18n.squareRootOperationName.text(),
                                                                                  Number.class ) );
     ...
     */
    SquareRoot( final Transformation transformation ) {
