...
public final class RoundTest {
    ...
    public void beforeEach() {
        this.operation = new Round( TestConstants.ID, TestConstants.TRANSFORM_ID );
    }
    ...
    public void shouldCalculateDoubleTerm() throws PolyglotterException {
        ...
        assertThat( this.operation.result(), is( ( Number ) Math.round( TestConstants.DOUBLE_1_VALUE ) ) );
    }

    @Test
    public void shouldCalculateFloatTerm() throws PolyglotterException {
        this.operation.add( TestConstants.FLOAT_1_TERM );
        assertThat( this.operation.result(), is( ( Number ) Math.round( TestConstants.FLOAT_1_VALUE ) ) );
    }
    ...
    public void shouldCalculateLongTerm() throws PolyglotterException {
        ...
        assertThat( this.operation.result(), is( ( Number ) TestConstants.LONG_1_VALUE ) );
    }

    @Test
    public void shouldHaveAbbreviation() {
        assertThat( this.operation.descriptor().abbreviation(), is( "round" ) );
    }
