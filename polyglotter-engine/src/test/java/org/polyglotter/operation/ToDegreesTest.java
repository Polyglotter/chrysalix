...
public final class ToDegreesTest implements TestConstants {

    private ToDegrees operation;

    @Before
    public void beforeEach() {
        this.operation = new ToDegrees( ID, TRANSFORM_ID );
    }
    ...
    public void shouldCalculateDoubleTerm() throws PolyglotterException {
        ...
        assertThat( this.operation.result(), is( Math.toDegrees( DOUBLE_1_VALUE ) ) );
    }

    @Test
    public void shouldCalculateFloatTerm() throws PolyglotterException {
        this.operation.add( FLOAT_1 );
        assertThat( this.operation.result(), is( Math.toDegrees( FLOAT_1_VALUE ) ) );
    }

    @Test
    public void shouldCalculateIntegerTerm() throws PolyglotterException {
        this.operation.add( INT_1 );
        assertThat( this.operation.result(), is( Math.toDegrees( INT_1_VALUE ) ) );
    }
