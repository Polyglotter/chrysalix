...
public final class PowerOfEMinus1Test {
    ...
    public void beforeEach() {
        this.operation = new PowerOfEMinus1( TestConstants.TEST_TRANSFORMATION );
    }
    ...
    public void shouldCalculateDoubleTerm() throws PolyglotterException {
        ...
        assertThat( this.operation.get(), is( ( Number ) Math.expm1( TestConstants.DOUBLE_1_VALUE ) ) );
    }

    @Test
    public void shouldCalculateFloatTerm() throws PolyglotterException {
        this.operation.addInput( TestConstants.FLOAT_1_TERM );
        assertThat( this.operation.get(), is( ( Number ) Math.expm1( TestConstants.FLOAT_1_VALUE ) ) );
    }

    @Test
    public void shouldCalculateIntegerTerm() throws PolyglotterException {
        this.operation.addInput( TestConstants.INT_1_TERM );
        assertThat( this.operation.get(), is( ( Number ) Math.expm1( TestConstants.INT_1_VALUE ) ) );
    }

    @Test
    public void shouldCalculateLongTerm() throws PolyglotterException {
        this.operation.addInput( TestConstants.LONG_1_TERM );
        assertThat( this.operation.get(), is( ( Number ) Math.expm1( TestConstants.LONG_1_VALUE ) ) );
    }
