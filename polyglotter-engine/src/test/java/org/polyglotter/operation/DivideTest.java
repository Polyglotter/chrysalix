...
public final class DivideTest {
    ...
    public void beforeEach() {
        this.operation = new Divide( TestConstants.ID, TestConstants.TRANSFORM_ID );
    }
    ...
    public void shouldDivideMultipleTerms() throws PolyglotterException {
        ...
        assertThat( this.operation.result(), is( ( Number ) ( TestConstants.INT_1_VALUE / TestConstants.INT_2_VALUE / TestConstants.DOUBLE_1_VALUE ) ) );
    }
