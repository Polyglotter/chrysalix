...
public final class MaxTest implements TestConstants {

    private Max operation;

    @Before
    public void beforeEach() {
        this.operation = new Max( ID, TRANSFORM_ID );
    }
    ...
    public void shouldCalculateIntegerResult() throws PolyglotterException {
        ...
        assertThat( this.operation.result().intValue(), is( INT_2_VALUE ) );
    }
    ...
    public void shouldFindMaxOfMultipleTerms() throws PolyglotterException {
        ...
        assertThat( this.operation.result(), is( ( Number ) Integer.valueOf( INT_2_VALUE ).doubleValue() ) );
    }
