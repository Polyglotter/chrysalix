...
public final class LogTest {
    ...
    public void beforeEach() {
        this.operation = new Log( TestConstants.ID, TestConstants.TRANSFORM_ID );
    }
    ...
    public void shouldCalculateDoubleTerm() throws PolyglotterException {
        ...
        assertThat( this.operation.result(), is( ( Number ) Math.log( TestConstants.DOUBLE_1_VALUE ) ) );
    }

    @Test
    public void shouldCalculateFloatTerm() throws PolyglotterException {
        this.operation.add( TestConstants.FLOAT_1_TERM );
        assertThat( this.operation.result(), is( ( Number ) Math.log( TestConstants.FLOAT_1_VALUE ) ) );
    }

    @Test
    public void shouldCalculateIntegerTerm() throws PolyglotterException {
        this.operation.add( TestConstants.INT_1_TERM );
        assertThat( this.operation.result(), is( ( Number ) Math.log( TestConstants.INT_1_VALUE ) ) );
    }

    @Test
    public void shouldCalculateLongTerm() throws PolyglotterException {
        this.operation.add( TestConstants.LONG_1_TERM );
        assertThat( this.operation.result(), is( ( Number ) Math.log( TestConstants.LONG_1_VALUE ) ) );
    }

    @Test
    public void shouldHaveAbbreviation() {
        assertThat( this.operation.descriptor().abbreviation(), is( "log" ) );
    }
