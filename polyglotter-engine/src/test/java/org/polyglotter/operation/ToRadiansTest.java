...
public final class ToRadiansTest {
    ...
    public void beforeEach() {
        this.operation = new ToRadians( TestConstants.ID, TestConstants.TRANSFORM_ID );
    }
    ...
    public void shouldCalculateDoubleTerm() throws PolyglotterException {
        ...
        assertThat( this.operation.result(), is( Math.toRadians( TestConstants.DOUBLE_1_VALUE ) ) );
    }

    @Test
    public void shouldCalculateFloatTerm() throws PolyglotterException {
        this.operation.add( TestConstants.FLOAT_1_TERM );
        assertThat( this.operation.result(), is( Math.toRadians( TestConstants.FLOAT_1_VALUE ) ) );
    }

    @Test
    public void shouldCalculateIntegerTerm() throws PolyglotterException {
        this.operation.add( TestConstants.INT_1_TERM );
        assertThat( this.operation.result(), is( Math.toRadians( TestConstants.INT_1_VALUE ) ) );
    }

    @Test
    public void shouldHaveAbbreviation() {
        assertThat( this.operation.descriptor().abbreviation(), is( "rad" ) );
    }
