...
public final class ModulusTest implements TestConstants {

    private Modulus operation;

    @Before
    public void beforeEach() {
        this.operation = new Modulus( ID, TRANSFORM_ID );
    }
    ...
    public void shouldCalculateDoubleTerms() throws PolyglotterException {
        ...
        assertThat( this.operation.result(), is( DOUBLE_1_VALUE % DOUBLE_2_VALUE ) );
    }
    ...
    public void shouldCalculateFloatTerms() throws PolyglotterException {
        ...
        assertThat( this.operation.result(), is( ( double ) FLOAT_1_VALUE % ( double ) FLOAT_2_VALUE ) );
    }
    ...
    public void shouldCalculateIntegerTerms() throws PolyglotterException {
        this.operation.add( INT_1 );
        this.operation.add( INT_2 );
        assertThat( this.operation.result(), is( ( double ) INT_1_VALUE % ( double ) INT_2_VALUE ) );
    }
    ...
    public void shouldCalculateMixedTerms() throws PolyglotterException {
        this.operation.add( INT_1 );
        this.operation.add( DOUBLE_1 );
        assertThat( this.operation.result(), is( INT_1_VALUE % DOUBLE_1_VALUE ) );
    }

    @Test
    public void shouldHaveAbbreviation() {
        assertThat( this.operation.abbreviation(), is( "mod" ) );
    }
