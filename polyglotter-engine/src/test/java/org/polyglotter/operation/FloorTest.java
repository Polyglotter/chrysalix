...
public final class FloorTest implements TestConstants {

    private Floor operation;

    @Before
    public void beforeEach() {
        this.operation = new Floor( ID, TRANSFORM_ID );
    }
    ...
    public void shouldCalculateDoubleTerm() throws PolyglotterException {
        ...
        assertThat( this.operation.result(), is( 12 ) );
    }
    ...
    public void shouldHaveAbbreviation() {
        assertThat( this.operation.descriptor().abbreviation(), is( "floor" ) );
    }
