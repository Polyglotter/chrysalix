 ...
 */
package org.polyglotter.common.i18n;
 ...
 * <p>
 * This repository for a property file by building locations of the form "path/to/class_locale.properties", where "path/to/class" is
 * created from the fully-qualified classname and all "." replaced with "/" characters, "locale" is the a variant of the locale
...
public final class ClasspathLocalizationRepository {
     ...
     * the {@link Locale#getDefault() default locale} (as that is done by the {@link I18n#text(Object...) calling} method.
     * 
     * @param classLoader
     *        the classloader that should be used to load the localization bundles
     * @param bundleName
     *        the name of the bundle of properties; never null
     * @param locale
     ...
     *         could be found
     */
    public static URL getLocalizationBundle( final ClassLoader classLoader,
                                             final String bundleName,
                                             final Locale locale ) {
        CheckArg.notNull( classLoader, "classLoader" );
        URL url = null;
        final List< String > paths = getPathsToSearchForBundle( bundleName, locale );
