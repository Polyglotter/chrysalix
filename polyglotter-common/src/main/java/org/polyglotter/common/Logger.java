 ...
 * auto-boxing features in Java 5, reducing the number of methods that are necessary and allowing callers to supply primitive values
 * as parameters.
 */
public abstract class Logger {
     ...
     * pair of empty curly braces for each of the parameter, which should be passed in the correct order. This method is efficient
     * and avoids superfluous object creation when the logger is disabled for the WARNING level.
     * 
     * @param message
     *        the message string
     * @param params
