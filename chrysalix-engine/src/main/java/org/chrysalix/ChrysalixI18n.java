...
/**
 * Internationalized string constants for the <strong>Chrysalix</strong> project.
 */
@SuppressWarnings( "javadoc" )
public class ChrysalixI18n {
    ...
    public static String localize( final String text,
        ...
        return I18n.localize( ChrysalixI18n.class, text, arguments );
    }
}
