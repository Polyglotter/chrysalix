...
public final class Cosine extends AbstractOperation< Double > {
    ...
    static final String DESCRIPTION = "Calculates the cosine of a numeric term";
    private static final String INPUT_DESCRIPTION = "The input term whose cosine is being calculated";
    private static final String INPUT_NAME = "Input";
    static final String NAME = "Cosine";
    ...
    public static final OperationDescriptor< Double > DESCRIPTOR =
        new AbstractOperationDescriptor< Double >( TransformationFactory.createId( Cosine.class ),
            ...
            public Operation< Double > newInstance( final ModelObject operation,
                ...
                return new Cosine( operation, transformation );
            }
     ...
     */
    Cosine( final ModelObject operation,
            final Transformation transformation ) throws ModelspaceException, ChrysalixException {
