...
public final class ToRadians extends AbstractOperation< Double > {
    ...
    static final String DESCRIPTION =
        "Converts an angle measured in degrees to an approximately equivalent angle measured in radians";
    private static final String INPUT_DESCRIPTION = "The input term whose values is being converted to radians";
    private static final String INPUT_NAME = "Input";
    static final String NAME = "To Radians";
    ...
    public static final OperationDescriptor< Double > DESCRIPTOR =
        new AbstractOperationDescriptor< Double >( TransformationFactory.createId( ToRadians.class ),
            ...
            public Operation< Double > newInstance( final ModelObject operation,
                ...
                return new ToRadians( operation, transformation );
            }
     ...
     */
    ToRadians( final ModelObject operation,
               final Transformation transformation ) throws ModelspaceException, ChrysalixException {
