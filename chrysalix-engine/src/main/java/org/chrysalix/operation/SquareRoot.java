 ...
 */
public final class SquareRoot extends AbstractOperation< Double > {

    static final String DESCRIPTION = "Calculates the square root of a numeric term";
    private static final String INPUT_DESCRIPTION = "The input term whose square root is being calculated";
    private static final String INPUT_NAME = "Input";
    static final String NAME = "Square Root";
    ...
    public static final OperationDescriptor< Double > DESCRIPTOR =
        new AbstractOperationDescriptor< Double >( TransformationFactory.createId( SquareRoot.class ),
            ...
            public Operation< Double > newInstance( final ModelObject operation,
                ...
                return new SquareRoot( operation, transformation );
            }
     ...
     */
    SquareRoot( final ModelObject operation,
                final Transformation transformation ) throws ModelspaceException, ChrysalixException {
