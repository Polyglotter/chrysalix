...
public final class Min extends AbstractOperation< Number > {
    ...
    static final String DESCRIPTION = "Finds the minimum value of two or more numbers";
    private static final String INPUT_DESCRIPTION = "An input term used to determine the minimum value of a set of terms.";
    ...
    public static final OperationDescriptor< Number > DESCRIPTOR =
        new AbstractOperationDescriptor< Number >( TransformationFactory.createId( Min.class ),
            ...
            public Operation< Number > newInstance( final ModelObject operation,
                ...
                return new Min( operation, transformation );
            }
     ...
     */
    Min( final ModelObject operation,
         final Transformation transformation ) throws ModelspaceException, ChrysalixException {
