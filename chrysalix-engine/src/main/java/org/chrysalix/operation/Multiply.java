...
public final class Multiply extends AbstractOperation< Number > {
    ...
    static final String DESCRIPTION = "Multiplies two or more numbers together";
    private static final String INPUT_DESCRIPTION = "An input term being multiplied by other terms.";
    ...
    public static final OperationDescriptor< Number > DESCRIPTOR =
        new AbstractOperationDescriptor< Number >( TransformationFactory.createId( Multiply.class ),
            ...
            public Operation< Number > newInstance( final ModelObject operation,
                ...
                return new Multiply( operation, transformation );
            }
     ...
     */
    Multiply( final ModelObject operation,
              final Transformation transformation ) throws ModelspaceException, ChrysalixException {
