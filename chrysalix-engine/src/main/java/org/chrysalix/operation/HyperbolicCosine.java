...
public final class HyperbolicCosine extends AbstractOperation< Double > {
    ...
    static final String DESCRIPTION = "Calculates the hyperbolic cosine of a numeric term";
    private static final String INPUT_DESCRIPTION = "The input term whose hyperbolic cosine is being calculated.";
    private static final String INPUT_NAME = "Input";
    static final String NAME = "Hyperbolic Cosine";
    ...
    public static final OperationDescriptor< Double > DESCRIPTOR =
        new AbstractOperationDescriptor< Double >( TransformationFactory.createId( HyperbolicCosine.class ),
            ...
            public Operation< Double > newInstance( final ModelObject operation,
                ...
                return new HyperbolicCosine( operation, transformation );
            }
     ...
     */
    HyperbolicCosine( final ModelObject operation,
                      final Transformation transformation ) throws ModelspaceException, ChrysalixException {
