...
import org.chrysalix.transformation.OperationCategory;
...
abstract class AbstractOperation< T > extends ValueImpl< T > implements Operation< T > {
     ...
     * {@inheritDoc}
     * 
     * @see org.chrysalix.transformation.Operation#addCategory(org.chrysalix.transformation.OperationCategory[])
     */
    @Override
    public void addCategory( final OperationCategory... categoriesToAdd ) throws ChrysalixException {
        ...
        for ( final OperationCategory category : categoriesToAdd ) {
            if ( ( category == null ) || !this.categories.add( category ) ) {
                throw new ChrysalixException( ChrysalixI18n.errorAddingOrRemovingOperationCategory,
                                                name(),
                                                transformationId() );
            }
        }
    ...
    public void addInput( final String descriptorId,
        ...
        if ( !isValidInputDescriptorId( descriptorId ) ) {
            throw new ChrysalixException( ChrysalixI18n.errorAddingOrRemovingOperationInput,
                                            name(),
                                            transformationId(),
                                            descriptorId );
        }
    ...
    public T get() throws ChrysalixException {
        ...
        throw new ChrysalixException( ChrysalixI18n.operationHasErrors, name(), transformationId() );
    }
     ...
     * {@inheritDoc}
     * 
     * @see org.chrysalix.transformation.Operation#removeCategory(org.chrysalix.transformation.OperationCategory[])
     */
    @Override
    public void removeCategory( final OperationCategory... categoriesToRemove ) throws ChrysalixException {
    ...
    public void removeInput( final String descriptorId,
        ...
        for ( final Object valueToDelete : valuesBeingRemoved ) {
            if ( valueToDelete == null ) {
                throw new ChrysalixException( ChrysalixI18n.errorRemovingOperationInput,
                                                name(),
                                                transformationId() );
            }
    ...
    public void set( final T newValue ) throws UnsupportedOperationException {
        throw new UnsupportedOperationException( ChrysalixI18n.operationResultNotModifiable.text( name(),
                                                                                                    transformation().id() ) );
    }
    ...
    public void setInput( final String descriptorId,
        ...
        if ( ( valuesBeingSet == null ) || ( valuesBeingSet.length == 0 ) ) {
            Chrysalix.LOGGER.debug( "Input values for descriptor '%s' were removed", descriptorId );
            return;
        }
            ...
            try {
                ...
                final ValidationProblem problem =
                    TransformationFactory.createError( descriptor().id(),
                                                       ChrysalixI18n.errorOnTermChanged.text( descriptor().id(),
                                                                                                transformationId() ) );
