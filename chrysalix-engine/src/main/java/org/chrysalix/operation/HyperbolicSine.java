...
public final class HyperbolicSine extends AbstractOperation< Double > {
    ...
    static final String DESCRIPTION = "Calculates the hyperbolic sine of a numeric term";
    private static final String INPUT_DESCRIPTION = "The input term whose hyperbolic sine is being calculated.";
    private static final String INPUT_NAME = "Input";
    static final String NAME = "Hyperbolic Sine";
    ...
    public static final OperationDescriptor< Double > DESCRIPTOR =
        new AbstractOperationDescriptor< Double >( TransformationFactory.createId( HyperbolicSine.class ),
            ...
            public Operation< Double > newInstance( final ModelObject operation,
                ...
                return new HyperbolicSine( operation, transformation );
            }
     ...
     */
    HyperbolicSine( final ModelObject operation,
                    final Transformation transformation ) throws ModelspaceException, ChrysalixException {
