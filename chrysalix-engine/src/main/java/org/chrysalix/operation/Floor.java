...
public final class Floor extends AbstractOperation< Integer > {
    ...
    static final String DESCRIPTION = "Find the closest integer less than or equal to the term";
    private static final String INPUT_DESCRIPTION = "The input term whose floor is being calculated";
    ...
    public static final OperationDescriptor< Integer > DESCRIPTOR =
        new AbstractOperationDescriptor< Integer >( TransformationFactory.createId( Floor.class ),
            ...
            public Operation< Integer > newInstance( final ModelObject operation,
                ...
                return new Floor( operation, transformation );
            }
     ...
     */
    Floor( final ModelObject operation,
           final Transformation transformation ) throws ModelspaceException, ChrysalixException {
