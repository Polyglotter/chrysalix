 ...
 */
public final class PowerOfEMinus1 extends AbstractOperation< Double > {

    static final String DESCRIPTION = "Calculates Euler's number raised to a power and then minus one";
    private static final String INPUT_DESCRIPTION = "The input term whose value is the power to raise Euler's number";
    private static final String INPUT_NAME = "Input";
    static final String NAME = "Power Of E Minus 1";
    ...
    public static final OperationDescriptor< Double > DESCRIPTOR =
        new AbstractOperationDescriptor< Double >( TransformationFactory.createId( PowerOfEMinus1.class ),
            ...
            public Operation< Double > newInstance( final ModelObject operation,
                ...
                return new PowerOfEMinus1( operation, transformation );
            }
     ...
     */
    PowerOfEMinus1( final ModelObject operation,
                    final Transformation transformation ) throws ModelspaceException, ChrysalixException {
