...
public final class ArcTangent extends AbstractOperation< Double > {
    ...
    static final String DESCRIPTION = "Calculates the arc tangent of a numeric term";
    private static final String INPUT_DESCRIPTION = "The input term whose arc sine is being calculated.";
    private static final String INPUT_NAME = "Input";
    static final String NAME = "Arc Tangent";
    ...
    public static final OperationDescriptor< Double > DESCRIPTOR =
        new AbstractOperationDescriptor< Double >( TransformationFactory.createId( ArcTangent.class ),
            ...
            public Operation< Double > newInstance( final ModelObject operation,
                ...
                return new ArcTangent( operation, transformation );
            }
     ...
     */
    ArcTangent( final ModelObject operation,
                final Transformation transformation ) throws ModelspaceException, ChrysalixException {
