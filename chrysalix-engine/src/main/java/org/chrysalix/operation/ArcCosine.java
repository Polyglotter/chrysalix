...
public final class ArcCosine extends AbstractOperation< Double > {
    ...
    static final String DESCRIPTION = "Calculates the arc cosine of a numeric term";
    private static final String INPUT_DESCRIPTION = "The input term whose arc cosine is being calculated.";
    private static final String INPUT_NAME = "Input";
    static final String NAME = "Arc Cosine";
    ...
    public static final OperationDescriptor< Double > DESCRIPTOR =
        new AbstractOperationDescriptor< Double >( TransformationFactory.createId( ArcCosine.class ),
            ...
            public Operation< Double > newInstance( final ModelObject operation,
                ...
                return new ArcCosine( operation, transformation );
            }
     ...
     */
    ArcCosine( final ModelObject operation,
               final Transformation transformation ) throws ModelspaceException, ChrysalixException {
