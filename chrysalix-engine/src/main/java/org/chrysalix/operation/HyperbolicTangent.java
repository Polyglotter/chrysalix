...
public final class HyperbolicTangent extends AbstractOperation< Double > {
    ...
    static final String DESCRIPTION = "Calculates the hyperbolic tangent of a numeric term";
    private static final String INPUT_DESCRIPTION = "The input term whose hyperbolic tangent is being calculated.";
    private static final String INPUT_NAME = "Input";
    static final String NAME = "Hyperbolic Tangent";
    ...
    public static final OperationDescriptor< Double > DESCRIPTOR =
        new AbstractOperationDescriptor< Double >( TransformationFactory.createId( HyperbolicTangent.class ),
            ...
            public Operation< Double > newInstance( final ModelObject operation,
                ...
                return new HyperbolicTangent( operation, transformation );
            }
     ...
     */
    HyperbolicTangent( final ModelObject operation,
                       final Transformation transformation ) throws ModelspaceException, ChrysalixException {
