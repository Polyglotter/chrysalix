...
public final class Sine extends AbstractOperation< Double > {
    ...
    static final String DESCRIPTION = "Calculates the sine of a numeric term";
    private static final String INPUT_DESCRIPTION = "The input term whose sine is being calculated";
    private static final String INPUT_NAME = "Input";
    static final String NAME = "Sine";
    ...
    public static final OperationDescriptor< Double > DESCRIPTOR =
        new AbstractOperationDescriptor< Double >( TransformationFactory.createId( Sine.class ),
            ...
            public Operation< Double > newInstance( final ModelObject operation,
                ...
                return new Sine( operation, transformation );
            }
     ...
     */
    Sine( final ModelObject operation,
          final Transformation transformation ) throws ModelspaceException, ChrysalixException {
