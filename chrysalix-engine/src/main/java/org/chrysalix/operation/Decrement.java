...
public final class Decrement extends AbstractOperation< Integer > {
    ...
    static final String DESCRIPTION = "Decrements its integer term";
    private static final String INPUT_DESCRIPTION = "The input term being decremented";
    private static final String INPUT_NAME = "Input";
    static final String NAME = "Decrement";
    ...
    public static final OperationDescriptor< Integer > DESCRIPTOR =
        new AbstractOperationDescriptor< Integer >( TransformationFactory.createId( Decrement.class ),
            ...
            public Operation< Integer > newInstance( final ModelObject operation,
                ...
                return new Decrement( operation, transformation );
            }
     ...
     */
    Decrement( final ModelObject operation,
               final Transformation transformation ) throws ModelspaceException, ChrysalixException {
