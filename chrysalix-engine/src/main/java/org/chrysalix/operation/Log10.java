...
public final class Log10 extends AbstractOperation< Double > {
    ...
    static final String DESCRIPTION = "Calculates base 10 logarithm of a term";
    private static final String INPUT_DESCRIPTION = "The input term whose log base 10 is being calculated";
    private static final String INPUT_NAME = "Input";
    static final String NAME = "Logarithm Base 10";
    ...
    public static final OperationDescriptor< Double > DESCRIPTOR =
        new AbstractOperationDescriptor< Double >( TransformationFactory.createId( Log10.class ),
            ...
            public Operation< Double > newInstance( final ModelObject operation,
                ...
                return new Log10( operation, transformation );
            }
     ...
     */
    Log10( final ModelObject operation,
           final Transformation transformation ) throws ModelspaceException, ChrysalixException {
