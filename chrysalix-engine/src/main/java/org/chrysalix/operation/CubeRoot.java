...
public final class CubeRoot extends AbstractOperation< Double > {
    ...
    static final String DESCRIPTION = "Calculates the cube root of a numeric term";
    private static final String INPUT_DESCRIPTION = "The input term whose cube root is being calculated";
    private static final String INPUT_NAME = "Input";
    static final String NAME = "Cube Root";
    ...
    public static final OperationDescriptor< Double > DESCRIPTOR =
        new AbstractOperationDescriptor< Double >( TransformationFactory.createId( CubeRoot.class ),
            ...
            public Operation< Double > newInstance( final ModelObject operation,
                ...
                return new CubeRoot( operation, transformation );
            }
     ...
     */
    CubeRoot( final ModelObject operation,
              final Transformation transformation ) throws ModelspaceException, ChrysalixException {
