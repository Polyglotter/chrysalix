...
public final class Log extends AbstractOperation< Double > {
    ...
    static final String DESCRIPTION = "Calculates natural logarithm of a term";
    private static final String INPUT_DESCRIPTION = "The input term whose log is being calculated";
    private static final String INPUT_NAME = "Input";
    static final String NAME = "Natural Logarithm";
    ...
    public static final OperationDescriptor< Double > DESCRIPTOR =
        new AbstractOperationDescriptor< Double >( TransformationFactory.createId( Log.class ),
            ...
            public Operation< Double > newInstance( final ModelObject operation,
                ...
                return new Log( operation, transformation );
            }
     ...
     */
    Log( final ModelObject operation,
         final Transformation transformation ) throws ModelspaceException, ChrysalixException {
