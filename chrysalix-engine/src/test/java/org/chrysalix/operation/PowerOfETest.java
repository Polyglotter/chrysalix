...
public final class PowerOfETest {
    ...
    private static final String ID = PowerOfE.TERM_DESCRIPTOR.name();
    ...
    public static void initializeConstants() throws Exception {
        ...
        DOUBLE_TERM =
            FACTORY.createNumberValue( "/my/path/double", PowerOfE.TERM_DESCRIPTOR, OperationTestConstants.DOUBLE_1_VALUE );
        FLOAT_TERM = FACTORY.createNumberValue( "/my/path/float", PowerOfE.TERM_DESCRIPTOR, OperationTestConstants.FLOAT_1_VALUE );
        INT_TERM = FACTORY.createNumberValue( "/my/path/int", PowerOfE.TERM_DESCRIPTOR, OperationTestConstants.INT_1_VALUE );
        INT2_TERM = FACTORY.createNumberValue( "/my/path/int2", PowerOfE.TERM_DESCRIPTOR, OperationTestConstants.INT_2_VALUE );
        LONG_TERM = FACTORY.createNumberValue( "/my/path/long", PowerOfE.TERM_DESCRIPTOR, OperationTestConstants.LONG_1_VALUE );
    }

    private ModelObject modelObject;
    private PowerOfE operation;

    @Before
    public void beforeEach() throws Exception {
        this.modelObject = mock( ModelObject.class );
        this.operation = new PowerOfE( this.modelObject, OperationTestConstants.TEST_TRANSFORMATION );
    }
    ...
    public void shouldCreateOperation() throws Exception {
        assertThat( PowerOfE.DESCRIPTOR.newInstance( this.modelObject, OperationTestConstants.TEST_TRANSFORMATION ),
                    is( instanceOf( PowerOfE.class ) ) );
    }
    ...
    public void shouldProvideDescription() throws Exception {
        assertThat( this.operation.descriptor().description(), is( ChrysalixI18n.localize( PowerOfE.DESCRIPTION ) ) );
    }

    @Test
    public void shouldProvideName() throws Exception {
        assertThat( this.operation.name(), is( ChrysalixI18n.localize( PowerOfE.NAME ) ) );
    }
