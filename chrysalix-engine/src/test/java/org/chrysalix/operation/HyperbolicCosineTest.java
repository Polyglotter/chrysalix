...
public final class HyperbolicCosineTest {
    ...
    private static final String ID = HyperbolicCosine.TERM_DESCRIPTOR.name();
    ...
    public static void initializeConstants() throws Exception {
        ...
        DOUBLE_TERM =
            FACTORY.createNumberValue( "/my/path/double", HyperbolicCosine.TERM_DESCRIPTOR, OperationTestConstants.DOUBLE_1_VALUE );
        FLOAT_TERM =
            FACTORY.createNumberValue( "/my/path/float", HyperbolicCosine.TERM_DESCRIPTOR, OperationTestConstants.FLOAT_1_VALUE );
        INT_TERM = FACTORY.createNumberValue( "/my/path/int", HyperbolicCosine.TERM_DESCRIPTOR, OperationTestConstants.INT_1_VALUE );
        INT2_TERM =
            FACTORY.createNumberValue( "/my/path/int2", HyperbolicCosine.TERM_DESCRIPTOR, OperationTestConstants.INT_2_VALUE );
        LONG_TERM =
            FACTORY.createNumberValue( "/my/path/long", HyperbolicCosine.TERM_DESCRIPTOR, OperationTestConstants.LONG_1_VALUE );
    }

    private ModelObject modelObject;
    private HyperbolicCosine operation;

    @Before
    public void beforeEach() throws Exception {
        this.modelObject = mock( ModelObject.class );
        this.operation = new HyperbolicCosine( this.modelObject, OperationTestConstants.TEST_TRANSFORMATION );
    }
    ...
    public void shouldCreateOperation() throws Exception {
        assertThat( HyperbolicCosine.DESCRIPTOR.newInstance( this.modelObject, OperationTestConstants.TEST_TRANSFORMATION ),
                    is( instanceOf( HyperbolicCosine.class ) ) );
    }
    ...
    public void shouldProvideDescription() throws Exception {
        assertThat( this.operation.descriptor().description(), is( ChrysalixI18n.localize( HyperbolicCosine.DESCRIPTION ) ) );
    }

    @Test
    public void shouldProvideName() throws Exception {
        assertThat( this.operation.name(), is( ChrysalixI18n.localize( HyperbolicCosine.NAME ) ) );
    }
