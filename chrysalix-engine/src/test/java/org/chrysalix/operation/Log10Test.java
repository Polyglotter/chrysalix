...
public final class Log10Test {
    ...
    private static final String ID = Log10.TERM_DESCRIPTOR.id();
    ...
    public static void initializeConstants() throws Exception {
        DOUBLE_TERM = TransformationFactory.createValue( Log10.TERM_DESCRIPTOR, OperationTestConstants.DOUBLE_1_VALUE );
        FLOAT_TERM = TransformationFactory.createValue( Log10.TERM_DESCRIPTOR, OperationTestConstants.FLOAT_1_VALUE );
        INT_TERM = TransformationFactory.createValue( Log10.TERM_DESCRIPTOR, OperationTestConstants.INT_1_VALUE );
        INT2_TERM = TransformationFactory.createValue( Log10.TERM_DESCRIPTOR, OperationTestConstants.INT_2_VALUE );
        LONG_TERM = TransformationFactory.createValue( Log10.TERM_DESCRIPTOR, OperationTestConstants.LONG_1_VALUE );
    }
    ...
    public void beforeEach() {
        this.operation = new Log10( OperationTestConstants.TEST_TRANSFORMATION );
    }
    ...
    public void shouldCreateOperation() {
        assertThat( Log10.DESCRIPTOR.newInstance( OperationTestConstants.TEST_TRANSFORMATION ),
