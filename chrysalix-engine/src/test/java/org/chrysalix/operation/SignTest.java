...
public final class SignTest {
    ...
    public static void initializeConstants() throws Exception {
        ...
        DOUBLE_TERM = FACTORY.createNumberValue( "/my/path/double", Sign.TERM_DESCRIPTOR, OperationTestConstants.DOUBLE_1_VALUE );
        DOUBLE_ZERO_TERM =
            FACTORY.createNumberValue( "/my/path/double_zero", Sign.TERM_DESCRIPTOR, OperationTestConstants.DOUBLE_ZERO_VALUE );
        FLOAT_TERM = FACTORY.createNumberValue( "/my/path/float", Sign.TERM_DESCRIPTOR, OperationTestConstants.FLOAT_1_VALUE );
        INT_TERM = FACTORY.createNumberValue( "/my/path/int", Sign.TERM_DESCRIPTOR, OperationTestConstants.INT_1_VALUE );
        INT2_TERM = FACTORY.createNumberValue( "/my/path/int2", Sign.TERM_DESCRIPTOR, OperationTestConstants.INT_2_VALUE );
        INT_ZERO_TERM =
            FACTORY.createNumberValue( "/my/path/int_zero", Sign.TERM_DESCRIPTOR, OperationTestConstants.INT_ZERO_VALUE );
        LONG_TERM = FACTORY.createNumberValue( "/my/path/long", Sign.TERM_DESCRIPTOR, OperationTestConstants.LONG_1_VALUE );
    }
    ...
    public void beforeEach() throws Exception {
        ...
        this.operation = new Sign( this.modelObject, OperationTestConstants.TEST_TRANSFORMATION );
    }
    ...
    public void shouldCreateOperation() throws Exception {
        assertThat( Sign.DESCRIPTOR.newInstance( this.modelObject, OperationTestConstants.TEST_TRANSFORMATION ),
                    is( instanceOf( Sign.class ) ) );
    }
    ...
    public void shouldProvideDescription() throws Exception {
        assertThat( this.operation.descriptor().description(), is( ChrysalixI18n.localize( Sign.DESCRIPTION ) ) );
    }

    @Test
    public void shouldProvideName() throws Exception {
        assertThat( this.operation.name(), is( ChrysalixI18n.localize( Sign.NAME ) ) );
    }
