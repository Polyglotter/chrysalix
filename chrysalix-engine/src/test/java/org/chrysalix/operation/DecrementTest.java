...
public final class DecrementTest {
    ...
    private static final String ID = Decrement.TERM_DESCRIPTOR.name();
    ...
    public static void initializeConstants() throws Exception {
        ...
        INT_TERM = FACTORY.createValue( "/my/path/int", Decrement.TERM_DESCRIPTOR, OperationTestConstants.INT_1_VALUE );
        INT2_TERM = FACTORY.createValue( "/my/path/int2", Decrement.TERM_DESCRIPTOR, OperationTestConstants.INT_2_VALUE );
    }
    ...
    public void beforeEach() throws Exception {
        ...
        this.operation = new Decrement( this.modelObject, OperationTestConstants.TEST_TRANSFORMATION );
    }
    ...
    public void shouldCreateOperation() throws Exception {
        assertThat( Decrement.DESCRIPTOR.newInstance( this.modelObject, OperationTestConstants.TEST_TRANSFORMATION ),
    ...
    public void shouldProvideDescription() throws Exception {
        assertThat( this.operation.descriptor().description(), is( ChrysalixI18n.localize( Decrement.DESCRIPTION ) ) );
    }

    @Test
    public void shouldProvideName() throws Exception {
        assertThat( this.operation.name(), is( ChrysalixI18n.localize( Decrement.NAME ) ) );
    }
