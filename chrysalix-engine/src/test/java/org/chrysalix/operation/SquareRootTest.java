...
public final class SquareRootTest {
    ...
    private static final String ID = SquareRoot.TERM_DESCRIPTOR.name();
    ...
    public static void initializeConstants() throws Exception {
        ...
        DOUBLE_TERM =
            FACTORY.createNumberValue( "/my/path/double", SquareRoot.TERM_DESCRIPTOR, OperationTestConstants.DOUBLE_1_VALUE );
        FLOAT_TERM = FACTORY.createNumberValue( "/my/path/float", SquareRoot.TERM_DESCRIPTOR, OperationTestConstants.FLOAT_1_VALUE );
        INT_TERM = FACTORY.createNumberValue( "/my/path/int", SquareRoot.TERM_DESCRIPTOR, OperationTestConstants.INT_1_VALUE );
        INT2_TERM = FACTORY.createNumberValue( "/my/path/int2", SquareRoot.TERM_DESCRIPTOR, OperationTestConstants.INT_2_VALUE );
        LONG_TERM = FACTORY.createNumberValue( "/my/path/long", SquareRoot.TERM_DESCRIPTOR, OperationTestConstants.LONG_1_VALUE );
    }
    ...
    public void beforeEach() throws Exception {
        ...
        this.operation = new SquareRoot( this.modelObject, OperationTestConstants.TEST_TRANSFORMATION );
    }
    ...
    public void shouldCreateOperation() throws Exception {
        assertThat( SquareRoot.DESCRIPTOR.newInstance( this.modelObject, OperationTestConstants.TEST_TRANSFORMATION ),
                    is( instanceOf( SquareRoot.class ) ) );
    }
    ...
    public void shouldProvideDescription() throws Exception {
        assertThat( this.operation.descriptor().description(), is( ChrysalixI18n.localize( SquareRoot.DESCRIPTION ) ) );
    }

    @Test
    public void shouldProvideName() throws Exception {
        assertThat( this.operation.name(), is( ChrysalixI18n.localize( SquareRoot.NAME ) ) );
    }
