...
public interface DdlConstants {
    ...
    public final static String[] SQL_92_RESERVED_WORDS =
    ...
    interface DataTypes {
        ...
        public final static List< String > DATATYPE_START_WORDS =
            Arrays.asList( new String[] { "CHAR", "CHARACTER", "VARCHAR",
    ...
    interface StatementStartPhrases {
        ...
        public final static String[][] SQL_92_ALL_PHRASES =
            { STMT_CREATE_SCHEMA, STMT_CREATE_TABLE,
        ...
        public final static String[] VALID_SCHEMA_CHILD_TYPES =
