...
public class ITJavaDependencyProcessor extends JavaIntegrationTest {
    ...
    // final Metamodel metamodel = metamodelManager().metamodel( "org.modelspace.java.JavaFile" );
    ...
    // // final Metamodel metamodel = metamodelManager().metamodel( "org.modelspace.java.JavaFile" );
    // final Metamodel metamodel = metamodelManager().metamodel( "org.modelspace.java.ClassFile" );
    // assertThat( metamodel, notNullValue() );
    // // final Model model =
    // // modelspace().generateModel( file, JavaDependencyProcessor.class.getPackage().getName().replace( '.', '/' ), metamodel );
    // final Model model =
    // modelspace().generateModel( getClass().getClassLoader().getResourceAsStream( name.replace( '.', '/' ) + ".class" ),
    ...
    // processor.process( modelNode, modelspace() );
    // return null;
    // }
    // } );
    // }
