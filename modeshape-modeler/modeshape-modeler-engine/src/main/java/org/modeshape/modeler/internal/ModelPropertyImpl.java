...
public class ModelPropertyImpl implements ModelProperty {
    ...
    static Object convert( final Value value,
        ...
        try {
            ...
            throw new ModelerException( e, ModelerI18n.localize( UNABLE_TO_CONVERT_VALUE, propertyType ) );
        }
    }
    ...
    ModelPropertyImpl( final ModelObjectImpl parent,
                       final Property jcrProperty ) throws ModelerException {
        ...
        try {
            ...
            throw new ModelerException( e, ModelerI18n.localize( UNABLE_TO_CONSTRUCT_PROPERTY, this.parent.name() ) );
        }
    }
     ...
     * {@inheritDoc}
     * 
     * @see org.modeshape.modeler.ModelProperty#booleanValue()
     */
    @Override
    public boolean booleanValue() throws ModelerException {
     ...
     * {@inheritDoc}
     * 
     * @see org.modeshape.modeler.ModelProperty#booleanValues()
     */
    @Override
    public boolean[] booleanValues() throws ModelerException {
        return modeler().run( new TaskWithResult< boolean[] >() {
     ...
     * {@inheritDoc}
     * 
     * @see org.modeshape.modeler.ModelProperty#dateValue()
     */
    @Override
    public Calendar dateValue() throws ModelerException {
        return modeler().run( new TaskWithResult< Calendar >() {
     ...
     * {@inheritDoc}
     * 
     * @see org.modeshape.modeler.ModelProperty#dateValues()
     */
    @Override
    public Calendar[] dateValues() throws ModelerException {
        return modeler().run( new TaskWithResult< Calendar[] >() {
     ...
     * {@inheritDoc}
     * 
     * @see org.modeshape.modeler.ModelProperty#decimalValue()
     */
    @Override
    public BigDecimal decimalValue() throws ModelerException {
        return modeler().run( new TaskWithResult< BigDecimal >() {
     ...
     * {@inheritDoc}
     * 
     * @see org.modeshape.modeler.ModelProperty#decimalValues()
     */
    @Override
    public BigDecimal[] decimalValues() throws ModelerException {
        return modeler().run( new TaskWithResult< BigDecimal[] >() {
     ...
     * {@inheritDoc}
     * 
     * @see org.modeshape.modeler.ModelProperty#descriptor()
     */
    @Override
    public PropertyDescriptor descriptor() throws ModelerException {
        return modeler().run( new TaskWithResult< PropertyDescriptor >() {
     ...
     * {@inheritDoc}
     * 
     * @see org.modeshape.modeler.ModelProperty#doubleValue()
     */
    @Override
    public double doubleValue() throws ModelerException {
        return modeler().run( new TaskWithResult< Double >() {
     ...
     * {@inheritDoc}
     * 
     * @see org.modeshape.modeler.ModelProperty#doubleValues()
     */
    @Override
    public double[] doubleValues() throws ModelerException {
        return modeler().run( new TaskWithResult< double[] >() {
     ...
     * {@inheritDoc}
     * 
     * @see org.modeshape.modeler.ModelProperty#longValue()
     */
    @Override
    public long longValue() throws ModelerException {
     ...
     * {@inheritDoc}
     * 
     * @see org.modeshape.modeler.ModelProperty#longValues()
     */
    @Override
    public long[] longValues() throws ModelerException {
        return modeler().run( new TaskWithResult< long[] >() {
    ...
    ModelerImpl modeler() {
        return this.parent.modeler;
    }

    /**
     * {@inheritDoc}
     * 
     * @see org.modeshape.modeler.ModelProperty#set(java.lang.Object[])
     */
    @Override
    public void set( final Object... values ) throws ModelerException {
                ...
                if ( values == null ) {
                    ...
                    if ( count == 0 ) {
                        ...
                        if ( multiple ) {
                            ...
                            throw new ModelerException( ModelerI18n.localize( ModelObjectImpl.UNABLE_TO_REMOVE_SINGLE_VALUE_PROPERTY_WITH_EMPTY_ARRAY,
                                                                              path,
                                                                              parent.name() ) );
                        }
                    } else if ( count > 1 ) {
                        if ( multiple ) {
                            ...
                            throw new ModelerException( ModelerI18n.localize( ModelObjectImpl.UNABLE_TO_SET_SINGLE_VALUE_PROPERTY_WITH_MULTIPLE_VALUES,
                                                                              property.getName(),
                                                                              parent.name() ) );
                        }
                    } else {
     ...
     * {@inheritDoc}
     * 
     * @see org.modeshape.modeler.ModelProperty#stringValue()
     */
    @Override
    public String stringValue() throws ModelerException {
     ...
     * {@inheritDoc}
     * 
     * @see org.modeshape.modeler.ModelProperty#stringValues()
     */
    @Override
    public String[] stringValues() throws ModelerException {
        return modeler().run( new TaskWithResult< String[] >() {
     ...
     * {@inheritDoc}
     * 
     * @see org.modeshape.modeler.ModelProperty#value()
     */
    @Override
    public Object value() throws ModelerException {
     ...
     * {@inheritDoc}
     * 
     * @see org.modeshape.modeler.ModelProperty#values()
     */
    @Override
    public Object[] values() throws ModelerException {
        return modeler().run( new TaskWithResult< Object[] >() {
