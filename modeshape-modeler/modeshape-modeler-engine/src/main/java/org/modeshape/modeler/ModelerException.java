 ...
 * 
 */
public class ModelerException extends BaseException {
     ...
     */
    public ModelerException( final I18n message,
    ...
    public ModelerException( final String message,
                             final Object... arguments ) {
        super( ModelerI18n.class, message, arguments );
    }
    ...
    public ModelerException( final Throwable cause,
                             ...
                             final Object... arguments ) {
        super( ModelerI18n.class, cause, message, arguments );
    }
}
