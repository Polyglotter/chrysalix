...
public interface MetamodelManager {
     ...
     *         if any problem occurs
     */
    String[] installableMetamodelCategories() throws ModelerException;
     ...
     *         if any error occurs
     */
    URL[] moveMetamodelRepositoryDown( final URL repositoryUrl ) throws ModelerException;
     ...
     *         if any error occurs
     */
    URL[] moveMetamodelRepositoryUp( final URL repositoryUrl ) throws ModelerException;
     ...
     *         if any error occurs
     */
    URL[] registerMetamodelRepository( final URL repositoryUrl ) throws ModelerException;
     ...
     *         if any error occurs
     */
    URL[] unregisterMetamodelRepository( final URL repositoryUrl ) throws ModelerException;
}
