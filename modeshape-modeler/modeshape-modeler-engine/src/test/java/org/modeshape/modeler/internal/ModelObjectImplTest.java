...
import org.modeshape.modeler.MockObjectFactory;
...
public class ModelObjectImplTest extends BaseModelObjectImplTest {
    ...
    @Test
    public void shouldGeStringValueWhenPropertyTypeIsName() throws Exception {
        final Value nameValue = MockObjectFactory.createNameValue();
        assertThat( ModelObjectImpl.getValue( nameValue, PropertyType.NAME ), is( instanceOf( String.class ) ) );
    }

    @Test
    public void shouldGeStringValueWhenPropertyTypeIsPath() throws Exception {
        final Value pathValue = MockObjectFactory.createNameValue();
        assertThat( ModelObjectImpl.getValue( pathValue, PropertyType.PATH ), is( instanceOf( String.class ) ) );
    }

    @Test
    public void shouldGeStringValueWhenPropertyTypeIsReference() throws Exception {
        final Value refValue = MockObjectFactory.createNameValue();
        assertThat( ModelObjectImpl.getValue( refValue, PropertyType.PATH ), is( instanceOf( String.class ) ) );
    }

    @Test
    public void shouldGeStringValueWhenPropertyTypeIsString() throws Exception {
        final Value stringValue = MockObjectFactory.createNameValue();
        assertThat( ModelObjectImpl.getValue( stringValue, PropertyType.WEAKREFERENCE ), is( instanceOf( String.class ) ) );
    }

    @Test
    public void shouldGeStringValueWhenPropertyTypeIsUri() throws Exception {
        final Value uriValue = MockObjectFactory.createNameValue();
        assertThat( ModelObjectImpl.getValue( uriValue, PropertyType.WEAKREFERENCE ), is( instanceOf( String.class ) ) );
    }

    @Test
    public void shouldGeStringValueWhenPropertyTypeIsWeakReference() throws Exception {
        final Value weakRefValue = MockObjectFactory.createNameValue();
        assertThat( ModelObjectImpl.getValue( weakRefValue, PropertyType.WEAKREFERENCE ), is( instanceOf( String.class ) ) );
    }
    ...
    @Test
    public void shouldGetBinaryValueWhenPropertyTypeIsBinary() throws Exception {
        final Value binaryValue = MockObjectFactory.createBinaryValue();
        assertThat( ModelObjectImpl.getValue( binaryValue, PropertyType.BINARY ), is( instanceOf( Binary.class ) ) );
    }

    @Test
    public void shouldGetBooleanValueWhenPropertyTypeIsBoolean() throws Exception {
        final Value booleanValue = MockObjectFactory.createBooleanValue();
        assertThat( ModelObjectImpl.getValue( booleanValue, PropertyType.BOOLEAN ), is( instanceOf( Boolean.class ) ) );
    }

    @Test
    public void shouldGetCalendarValueWhenPropertyTypeIsDate() throws Exception {
        final Value dateValue = MockObjectFactory.createDateValue();
        assertThat( ModelObjectImpl.getValue( dateValue, PropertyType.DATE ), is( instanceOf( Calendar.class ) ) );
    }
    ...
    @Test
    public void shouldGetDoubleValueWhenPropertyTypeIsDouble() throws Exception {
        final Value doubleValue = MockObjectFactory.createDoubleValue();
        assertThat( ModelObjectImpl.getValue( doubleValue, PropertyType.DOUBLE ), is( instanceOf( Double.class ) ) );
    }
    ...
    @Test
    public void shouldGetLongValueWhenPropertyTypeIsLong() throws Exception {
        final Value longValue = MockObjectFactory.createLongValue();
        assertThat( ModelObjectImpl.getValue( longValue, PropertyType.LONG ), is( instanceOf( Long.class ) ) );
    }
